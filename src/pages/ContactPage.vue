    ...
    <div class="max-w-[1400px] mx-auto px-6 lg:px-12 py-32">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
        <div v-for="(info, i) in contactInfo" :key="i" 
          ...
          <p v-for="detail in info.details" :key="detail" class="text-gray-600 dark:text-gray-400 font-medium leading-relaxed">{{ detail }}</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-20">
        ...
        <div class="space-y-8">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-2xl shadow border border-gray-200 dark:border-gray-700 p-8">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-4">For urgent matters outside office hours, call our emergency line:</p>
