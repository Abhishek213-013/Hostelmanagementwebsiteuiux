  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="max-w-[1400px] mx-auto px-6 lg:px-12 py-32">
      <div class="mb-12">
        ...
        <p class="text-lg text-gray-600 max-w-2xl">View and manage your booked rooms and reservations</p>
      </div>

      <div v-if="myRooms.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div v-for="room in myRooms" :key="room.id" class="bg-white rounded-2xl overflow-hidden shadow border border-gray-200 hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
        ...
        <h3 class="text-xl font-bold text-gray-600 mb-2">No Rooms Booked Yet</h3>
        <p class="text-gray-500 mb-6">Explore our available rooms and book your stay</p>
