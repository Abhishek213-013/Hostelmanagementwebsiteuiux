  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="max-w-[1400px] mx-auto px-6 lg:px-12 py-32">
      <div class="mb-12">
        ...
        <p class="text-lg text-gray-600 max-w-2xl">Update your personal information and manage your account settings</p>
      </div>
          ...
          <form @submit.prevent="saveProfile" class="space-y-4">
            <div>
              ...
              <input 
                ...
                type="text" 
                class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-200 transition-colors text-sm text-gray-900 bg-gray-50 placeholder-gray-500" 
            ...
            <div>
              ...
              <input 
                ...
                type="date" 
                class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-200 transition-colors text-sm text-gray-900 bg-gray-50" 
              />
            </div>
            <div>
