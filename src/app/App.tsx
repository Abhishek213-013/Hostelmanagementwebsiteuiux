...
export default function App() {
  ...
  const galleryImages = [
    ...
    { src: 'https://images.unsplash.com/photo-1635321349359-333da6bb6da9?w=1200', label: 'Reception' },
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden shadow border border-gray-200">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                          ...
                          <Link to={`/rooms/${room.type}`} className="px-6 py-3 text-white rounded-xl font-bold bg-teal-600">
                            View Details
                          </Link>
                        </div>
                      </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {galleryImages.map((item, i) => (
                <div
                  ...
                  className={`relative rounded-2xl overflow-hidden shadow group hover:opacity-80 transition-all duration-300 cursor-pointer ${i % 2 === 1 ? 'mt-8' : ''}`}
                >
              ...
              <div className="relative rounded-2xl overflow-hidden flex items-center justify-center bg-gray-700 cursor-pointer" onClick={() => openLightbox(0)}>
          ...
          >
            ...
            <div className="max-w-5xl max-h-[80vh] mx-6" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-white text-sm mt-3 font-medium">{currentImageIndex + 1} / {galleryImages.length}</p>
              </div>
            </div>
          </div>
        )}
